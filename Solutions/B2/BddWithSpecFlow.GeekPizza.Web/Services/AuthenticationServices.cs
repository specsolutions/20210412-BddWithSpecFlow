    ...
    public static class AuthenticationServices
    {
        ...
        public static string EnsureAuthenticated(HttpContext httpContext, string requestToken)
        {
            ...
            if (currentUserName == null)
                throw new AuthenticationException(new HttpResponseMessage(HttpStatusCode.Forbidden) {ReasonPhrase = "Not logged in"}.ToString());
        ...
        public static void EnsureAdminAuthenticated(HttpContext httpContext, string requestToken)
        {
            ...
            if (currentUserName != DefaultDataServices.AdminUserName)
                throw new AuthenticationException(new HttpResponseMessage(HttpStatusCode.Forbidden) { ReasonPhrase = "Not admin" }.ToString());
        }
        ...
        public static bool IsSuccessful(this IActionResult actionResult)
        {
            return actionResult is ContentResult;
        }
    }
}